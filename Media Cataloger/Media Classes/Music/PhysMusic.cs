...
{
    public class PhysMusic : Music, IPhysical
    {
        ...
        public PhysMusic (string albumTitle, string artist, string format) : base(albumTitle, artist)
        {
            this.Format = format;
        }

        public PhysMusic(string albumTitle, string artist, string release, string genre, string format,  string cas, string manual, string condition)
